...
export default function OfferBatchesPage() {
 ...
 draft: "bg-gray-500",
 pending_review: "bg-warning-bg",
 sent: "bg-info-bg",
 partial_accepted: "bg-purple-500",
 accepted: "bg-success-bg",
 expired: "bg-error-bg",
 ...
 <div className="bg-info-bg/10 p-3 rounded-lg">
 ...
 <CardContent className="pt-6">
 <div className="flex items-center gap-4">
 <div className="bg-warning-bg/10 p-3 rounded-lg">
 ...
 <CardContent className="pt-6">
 <div className="flex items-center gap-4">
 <div className="bg-success-bg/10 p-3 rounded-lg">
