...
export default function BuyersPage() {
 ...
 <CardContent>
 <div className="font-bold text-success text-2xl">{stats.active}</div>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
 ...
 <CardContent>
 <div className="font-bold text-info text-2xl">{stats.draft}</div>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
 ...
 <CardContent>
 <div className="font-bold text-error text-2xl">{stats.suspended}</div>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
 ...
 <DropdownMenuItem 
 className="focus:bg-error-bg text-error focus:text-error"
 ...
 className={formErrors.name ? 'border-error-border' : ''}
 />
 {formErrors.name && <p className="text-error text-sm">{formErrors.name}</p>}
 </div>
 <div className="space-y-2 col-span-2 sm:col-span-1">
 ...
 Buyer Code <span className="text-error">*</span>
 </Label>
 <Input
 id="code"
 value={formData.code || ''}
 ...
 className={formErrors.code ? 'border-error-border' : ''}
 />
 {formErrors.code && <p className="text-error text-sm">{formErrors.code}</p>}
 ...
 <SelectItem value="B">
 <div className="flex items-center gap-2">
 <span className="bg-warning rounded-full w-2 h-2" />
 Tier B - Standard
 </div>
 </SelectItem>
 <SelectItem value="C">
 <div className="flex items-center gap-2">
 <span className="bg-error rounded-full w-2 h-2" />
 Tier C - Higher Risk
 </div>
 </SelectItem>
 </SelectContent>
 ...
 className={formErrors.contact_email ? 'border-error-border' : ''}
 />
 {formErrors.contact_email && <p className="text-error text-sm">{formErrors.contact_email}</p>}
 </div>
 <div className="space-y-2">
 ...
 className={formErrors.financial_contact_email ? 'border-error-border' : ''}
 />
 {formErrors.financial_contact_email && <p className="text-error text-sm">{formErrors.financial_contact_email}</p>}
 </div>
 </CardContent>
 </Card>
 </div>
 ...
 className={formErrors.min_invoice_amount ? 'border-error-border' : ''}
 />
 {formErrors.min_invoice_amount && <p className="text-error text-sm">{formErrors.min_invoice_amount}</p>}
 </div>
 <div className="space-y-2">
 ...
 className={formErrors.min_days_to_maturity ? 'border-error-border' : ''}
 />
 {formErrors.min_days_to_maturity && <p className="text-error text-sm">{formErrors.min_days_to_maturity}</p>}
 </div>
 <div className="space-y-2">
 ...
 <div className="flex items-start gap-3 bg-warning-bg p-4 border border-warning-border rounded-lg">
 <AlertCircle className="mt-0.5 w-5 h-5 text-warning" />
 <div>
 <p className="font-medium text-warning-foreground">Important Notice</p>
