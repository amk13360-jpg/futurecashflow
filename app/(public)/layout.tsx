...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Future Mining Finance is a fintech and funding platform enabling mining companies to offer early payment programs for SMEs in their supply chain. Registered Credit Provider NCRCP18174.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Future Mining Finance - African Mining Supply Chain Finance Reimagined",
    description:
      "Future Mining Finance is a fintech and funding platform enabling mining companies to offer early payment programs for SMEs in their supply chain.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={cn("bg-background min-h-screen font-sans text-foreground antialiased", inter.className)}>
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem={true}>
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:top-2 focus:left-2 z-50 focus:absolute bg-secondary px-4 py-2 rounded-md text-secondary-foreground transition-all duration-200"
          >
