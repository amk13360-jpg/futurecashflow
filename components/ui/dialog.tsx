...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        'z-50 fixed inset-0 bg-black/40 dark:bg-black/60 data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 backdrop-blur-sm',
        className,
      )}
      {...props}
    />
